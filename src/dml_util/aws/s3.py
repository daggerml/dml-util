...
from dml_util.core.utils import compute_hash, exactly_one, js_dump
...
class S3Store:
    ...
    def cd(self, new_prefix) -> "S3Store":
        ...
        new_path = (root / new_prefix).resolve().relative_to(os.getcwd())
        return replace(self, prefix=str(new_path))
